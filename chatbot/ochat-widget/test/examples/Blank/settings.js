...
var ochatWidgetSettings = {
    uri: 'ws://localhost:8888/chat/ws',// bot chat server uri
    channel: '',// bot channel id
    userId: '1',// bot chat server user id
    isDebugMode: false,// enable / disable logging
    chatTitle: 'Pizza Bot',// chat title
    miniTitle: 'Order Pizza',// chat title when it minimized
    ...
    //  right: // can't be used in combination with "left".
    //  top: // can't be used in combination with "bottom".
    //  bottom: // can't be used in combination with "top".
    // },
