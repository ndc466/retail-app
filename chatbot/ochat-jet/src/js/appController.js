...
define(['ojs/ojcore', 'knockout', 'jquery',
    ...
    function (oj, ko, $, data, mapping) {
        ...
        function AppControllerViewModel() {
            ...
            //open chat window
            self.goToChat = function (id, from) {
                self.router.go('chat/' + id);
                self.fromChatsMain = from;
            }
            ...
            self.goToChatMain = function () {
                var destination = self.fromChatsMain || 'chatsMain';
                self.router.go('chatsMain/' + destination);
            };

            //add a new channel to chat
            self.goToCreateChannel = function () {
                self.fromChatsMain = 'chatsMain';
                self.router.go('createIncident');
            };

            self.goToAddBot = function () {
                //business logic for adding a new bot
            };
