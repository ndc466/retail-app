...
# source: tf_detection/protos/hyperparams.proto
...
_HYPERPARAMS_OP = _descriptor.EnumDescriptor(
  name='Op',
  full_name='tf_detection.protos.Hyperparams.Op',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_HYPERPARAMS_ACTIVATION = _descriptor.EnumDescriptor(
  name='Activation',
  full_name='tf_detection.protos.Hyperparams.Activation',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_VARIANCESCALINGINITIALIZER_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='tf_detection.protos.VarianceScalingInitializer.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_HYPERPARAMS = _descriptor.Descriptor(
  name='Hyperparams',
  full_name='tf_detection.protos.Hyperparams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='op', full_name='tf_detection.protos.Hyperparams.op', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='regularizer', full_name='tf_detection.protos.Hyperparams.regularizer', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='initializer', full_name='tf_detection.protos.Hyperparams.initializer', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='activation', full_name='tf_detection.protos.Hyperparams.activation', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_norm', full_name='tf_detection.protos.Hyperparams.batch_norm', index=4,
...
_REGULARIZER = _descriptor.Descriptor(
  name='Regularizer',
  full_name='tf_detection.protos.Regularizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='l1_regularizer', full_name='tf_detection.protos.Regularizer.l1_regularizer', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='l2_regularizer', full_name='tf_detection.protos.Regularizer.l2_regularizer', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_L1REGULARIZER = _descriptor.Descriptor(
  name='L1Regularizer',
  full_name='tf_detection.protos.L1Regularizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_L2REGULARIZER = _descriptor.Descriptor(
  name='L2Regularizer',
  full_name='tf_detection.protos.L2Regularizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_INITIALIZER = _descriptor.Descriptor(
  name='Initializer',
  full_name='tf_detection.protos.Initializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='truncated_normal_initializer', full_name='tf_detection.protos.Initializer.truncated_normal_initializer', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='variance_scaling_initializer', full_name='tf_detection.protos.Initializer.variance_scaling_initializer', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRUNCATEDNORMALINITIALIZER = _descriptor.Descriptor(
  ...
  full_name='tf_detection.protos.TruncatedNormalInitializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_VARIANCESCALINGINITIALIZER = _descriptor.Descriptor(
  ...
  full_name='tf_detection.protos.VarianceScalingInitializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='uniform', full_name='tf_detection.protos.VarianceScalingInitializer.uniform', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mode', full_name='tf_detection.protos.VarianceScalingInitializer.mode', index=2,
...
_BATCHNORM = _descriptor.Descriptor(
  name='BatchNorm',
  full_name='tf_detection.protos.BatchNorm',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='center', full_name='tf_detection.protos.BatchNorm.center', index=1,
      number=2, type=8, cpp_type=7, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale', full_name='tf_detection.protos.BatchNorm.scale', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='train', full_name='tf_detection.protos.BatchNorm.train', index=4,
...
Hyperparams = _reflection.GeneratedProtocolMessageType('Hyperparams', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.Hyperparams)
  ))
...
Regularizer = _reflection.GeneratedProtocolMessageType('Regularizer', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.Regularizer)
  ))
...
L1Regularizer = _reflection.GeneratedProtocolMessageType('L1Regularizer', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.L1Regularizer)
  ))
...
L2Regularizer = _reflection.GeneratedProtocolMessageType('L2Regularizer', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.L2Regularizer)
  ))
...
Initializer = _reflection.GeneratedProtocolMessageType('Initializer', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.Initializer)
  ))
...
TruncatedNormalInitializer = _reflection.GeneratedProtocolMessageType('TruncatedNormalInitializer', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.TruncatedNormalInitializer)
  ))
...
VarianceScalingInitializer = _reflection.GeneratedProtocolMessageType('VarianceScalingInitializer', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.VarianceScalingInitializer)
  ))
...
BatchNorm = _reflection.GeneratedProtocolMessageType('BatchNorm', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.BatchNorm)
  ))
