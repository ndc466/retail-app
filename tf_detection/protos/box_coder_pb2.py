...
# source: tf_detection/protos/box_coder.proto
...
_BOXCODER = _descriptor.Descriptor(
  name='BoxCoder',
  full_name='tf_detection.protos.BoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='faster_rcnn_box_coder', full_name='tf_detection.protos.BoxCoder.faster_rcnn_box_coder', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mean_stddev_box_coder', full_name='tf_detection.protos.BoxCoder.mean_stddev_box_coder', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='square_box_coder', full_name='tf_detection.protos.BoxCoder.square_box_coder', index=2,
...
BoxCoder = _reflection.GeneratedProtocolMessageType('BoxCoder', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.box_coder_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.BoxCoder)
  ))
