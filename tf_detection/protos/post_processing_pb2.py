...
# source: tf_detection/protos/post_processing.proto
...
_POSTPROCESSING_SCORECONVERTER = _descriptor.EnumDescriptor(
  name='ScoreConverter',
  full_name='tf_detection.protos.PostProcessing.ScoreConverter',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_BATCHNONMAXSUPPRESSION = _descriptor.Descriptor(
  ...
  full_name='tf_detection.protos.BatchNonMaxSuppression',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_detections_per_class', full_name='tf_detection.protos.BatchNonMaxSuppression.max_detections_per_class', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_total_detections', full_name='tf_detection.protos.BatchNonMaxSuppression.max_total_detections', index=3,
...
_POSTPROCESSING = _descriptor.Descriptor(
  name='PostProcessing',
  full_name='tf_detection.protos.PostProcessing',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='batch_non_max_suppression', full_name='tf_detection.protos.PostProcessing.batch_non_max_suppression', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='score_converter', full_name='tf_detection.protos.PostProcessing.score_converter', index=1,
...
BatchNonMaxSuppression = _reflection.GeneratedProtocolMessageType('BatchNonMaxSuppression', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.post_processing_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.BatchNonMaxSuppression)
  ))
...
PostProcessing = _reflection.GeneratedProtocolMessageType('PostProcessing', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.post_processing_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.PostProcessing)
  ))
