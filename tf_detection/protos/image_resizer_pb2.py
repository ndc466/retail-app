...
# source: tf_detection/protos/image_resizer.proto
...
_IMAGERESIZER = _descriptor.Descriptor(
  name='ImageResizer',
  full_name='tf_detection.protos.ImageResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keep_aspect_ratio_resizer', full_name='tf_detection.protos.ImageResizer.keep_aspect_ratio_resizer', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fixed_shape_resizer', full_name='tf_detection.protos.ImageResizer.fixed_shape_resizer', index=1,
...
_KEEPASPECTRATIORESIZER = _descriptor.Descriptor(
  ...
  full_name='tf_detection.protos.KeepAspectRatioResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_dimension', full_name='tf_detection.protos.KeepAspectRatioResizer.min_dimension', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_dimension', full_name='tf_detection.protos.KeepAspectRatioResizer.max_dimension', index=1,
...
_FIXEDSHAPERESIZER = _descriptor.Descriptor(
  ...
  full_name='tf_detection.protos.FixedShapeResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='tf_detection.protos.FixedShapeResizer.height', index=0,
      number=1, type=5, cpp_type=1, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width', full_name='tf_detection.protos.FixedShapeResizer.width', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=300,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ImageResizer = _reflection.GeneratedProtocolMessageType('ImageResizer', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.ImageResizer)
  ))
...
KeepAspectRatioResizer = _reflection.GeneratedProtocolMessageType('KeepAspectRatioResizer', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.KeepAspectRatioResizer)
  ))
...
FixedShapeResizer = _reflection.GeneratedProtocolMessageType('FixedShapeResizer', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.FixedShapeResizer)
  ))
