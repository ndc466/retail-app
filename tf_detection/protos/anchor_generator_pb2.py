...
# source: tf_detection/protos/anchor_generator.proto
...
_ANCHORGENERATOR = _descriptor.Descriptor(
  ...
  full_name='tf_detection.protos.AnchorGenerator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='grid_anchor_generator', full_name='tf_detection.protos.AnchorGenerator.grid_anchor_generator', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ssd_anchor_generator', full_name='tf_detection.protos.AnchorGenerator.ssd_anchor_generator', index=1,
...
AnchorGenerator = _reflection.GeneratedProtocolMessageType('AnchorGenerator', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.anchor_generator_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.AnchorGenerator)
  ))
