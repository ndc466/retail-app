...
# source: tf_detection/protos/argmax_matcher.proto
...
_ARGMAXMATCHER = _descriptor.Descriptor(
  name='ArgMaxMatcher',
  full_name='tf_detection.protos.ArgMaxMatcher',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ignore_thresholds', full_name='tf_detection.protos.ArgMaxMatcher.ignore_thresholds', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='negatives_lower_than_unmatched', full_name='tf_detection.protos.ArgMaxMatcher.negatives_lower_than_unmatched', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='force_match_for_each_row', full_name='tf_detection.protos.ArgMaxMatcher.force_match_for_each_row', index=4,
...
ArgMaxMatcher = _reflection.GeneratedProtocolMessageType('ArgMaxMatcher', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.argmax_matcher_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.ArgMaxMatcher)
  ))
