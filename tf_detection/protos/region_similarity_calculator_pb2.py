...
# source: tf_detection/protos/region_similarity_calculator.proto
...
_REGIONSIMILARITYCALCULATOR = _descriptor.Descriptor(
  ...
  full_name='tf_detection.protos.RegionSimilarityCalculator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='neg_sq_dist_similarity', full_name='tf_detection.protos.RegionSimilarityCalculator.neg_sq_dist_similarity', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='iou_similarity', full_name='tf_detection.protos.RegionSimilarityCalculator.iou_similarity', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ioa_similarity', full_name='tf_detection.protos.RegionSimilarityCalculator.ioa_similarity', index=2,
...
_NEGSQDISTSIMILARITY = _descriptor.Descriptor(
  ...
  full_name='tf_detection.protos.NegSqDistSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_IOUSIMILARITY = _descriptor.Descriptor(
  name='IouSimilarity',
  full_name='tf_detection.protos.IouSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_IOASIMILARITY = _descriptor.Descriptor(
  name='IoaSimilarity',
  full_name='tf_detection.protos.IoaSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
RegionSimilarityCalculator = _reflection.GeneratedProtocolMessageType('RegionSimilarityCalculator', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.RegionSimilarityCalculator)
  ))
...
NegSqDistSimilarity = _reflection.GeneratedProtocolMessageType('NegSqDistSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.NegSqDistSimilarity)
  ))
...
IouSimilarity = _reflection.GeneratedProtocolMessageType('IouSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.IouSimilarity)
  ))
...
IoaSimilarity = _reflection.GeneratedProtocolMessageType('IoaSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'tf_detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:tf_detection.protos.IoaSimilarity)
  ))
